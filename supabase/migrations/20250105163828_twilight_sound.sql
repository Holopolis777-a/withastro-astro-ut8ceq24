/*
  ...
  1. New Tables
    - `regular_vehicles`
      - Base vehicle table with all common fields
    - `pool_vehicles`
      - Pool vehicle table with same structure as regular vehicles
    - `salary_vehicles`
      - Salary sacrifice vehicle table with same structure as regular vehicles
  ...
  3. Changes
    - Add standard_equipment field
    - Add monthly_starting_rate field for salary vehicles
*/
